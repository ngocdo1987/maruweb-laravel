<div class="form-group">
    <label for="corporation_name" class="col-sm-3 control-label">{{ __('Corporation name') }} <font color="red">※</font></label>
    <div class="col-sm-9">
...
<div class="form-group">
    <label for="corporation_name_kana" class="col-sm-3 control-label">{{ __('Corporation name (kana)') }} <font color="red">※</font></label>
    <div class="col-sm-9">
...
<!-- Head office -->
@include('admin.users.edit._address', [
    'name' => 'head_office',
...
<div class="form-group">
    <label for="" class="col-sm-3 control-label">{{ __('Association notification representative name (kana)') }} <font color="red">※</font></label>
    <div class="col-sm-4">
...
<!-- Contact -->
<div class="form-group">
    <label for="" class="col-sm-3 control-label">{{ __('Receive name') }} <font color="red">※</font></label>
    <div class="col-sm-9">
...
<div class="form-group">
    <label for="" class="col-sm-3 control-label">{{ __('Contact name') }} <font color="red">※</font></label>
    <div class="col-sm-4">
...
<div class="form-group">
    <label for="" class="col-sm-3 control-label">{{ __('Contact name (kana)') }} <font color="red">※</font></label>
    <div class="col-sm-4">
...
<div class="form-group">
    <label for="" class="col-sm-3 control-label">{{ __('Number of applications') }} <font color="red">※</font></label>
    <div class="col-sm-8">
        <select name="number_of_applications" id="number_of_applications" class="form-control">
            <option value="">--</option>
            @for ($i = 1; $i <= 20; $i++)
                @php
                    $selected = $i == old('number_of_applications', $user->number_of_applications) ? ' selected' : ''
                @endphp
                <option value="{{ $i }}"{{ $selected }}>{{ $i }}</option>
            @endfor
        </select>

        @error('number_of_applications')
            <font color="red">{{ $message }}</font>
        @enderror
    </div>
