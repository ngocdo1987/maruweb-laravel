...
return array (
    ...
    'current_password' => '現在のパスワードに誤りが御座います。',
    'must_choose_city' => '市区町村まで選択してください',

    'katakana_full_width' => '全角カタカナで入力してください。',
    'number_and_hyphen' => '半角数字10文字以上で入力してください',
    'complex_password' => '数字、英小文字、英大文字、記号（. -_!）の4種類で組み合わせてください。',
    'captcha' => '「私はロボットではありません」にチェックを入れてください',
    'postal_code' => '正しい郵便番号を入力してください。',
